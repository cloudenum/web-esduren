...
<div class="wrap-tb-bg">
	<div class="tb-background">
		...
		<div class="tb-background-img" style="bottom: 0px">
			<img src="<?php echo base_url(); ?>bakul/img/about.jpg" alt="banner">
		</div>
	</div>
</div>
<div class="tb-text">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="about-us-img-left">
						<img src="<?php echo base_url(); ?>bakul/img/about-a.jpg" alt="image">
					</div>
					<br>
					<br></div>
				<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="about-us-img-right">
						<img src="<?php echo base_url(); ?>bakul/img/about-b.jpg" alt="image">
					</div>
					<br></div>
			</div>
		</div>
