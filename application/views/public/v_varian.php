		...
		<div class="row">
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-fried-rice.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-noodle.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-gudeg.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-tongseng.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
			...
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-roasted-duck.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-soup.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-prawn.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-tofu.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
		...
		<div class="row">
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-tiramisu.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
			...
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/rainbow-cake.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-mousse.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
		...
		<div class="row">
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-soto.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
			...
			<div class="col-md-6 col-sm-12">
				...
				<div class="menu-item">
					<div class="menu-item-wrap">
						<div class="miw-left">
							<div class="menu-item-img" style="background-image: url('<?php echo base_url(); ?>bakul/img/menu-chicken-vegetable.jpg')">
							</div>
						</div>
						<div class="miw-right">
							<div class="miw-info">
