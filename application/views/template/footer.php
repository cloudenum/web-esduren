							...
							<div class="open-hours-wrap">
								...
								?>
										<div class="oh-day">
											...
											<div class="ohd-time"><?php if ($row->flag != 0) {
																		echo substr($row->open_hour, 0, 5); ?> - <?php echo substr($row->close_hour, 0, 5);
																												} else {
																													echo "Tutup";
																												} ?></div>
											<div class="clear"></div>
								...
								<div class="reserphone">
									...
									Call <span class="text-theme">&nbsp;&nbsp;<?php echo $profil->phone; ?></span>
								</div>
							</div>
						</div>
						<div class="clear"></div>
