				...
				<div class="box-body">
					<?php echo form_open_multipart('crud/insert_menu', array('class' => 'needs-validation', 'novalidate' => ''));?>
						...
						<div class="form-group">
							...
							<p class="help-block">Upload gambar/foto menu es durian yang akan ditambahkan.</p>
						...
						<div class="row">
							<div class="col-sm-12"  style="overflow: auto; background: white;">
								<table id="menu-table" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example1_info">
									...
									<tbody>
										<?php 
											$query = $this->db->query('SELECT M.*, F.category FROM menu M, food_category F WHERE M.food_category_id = F.id');
										...
										<tr role="row">
                                            ...
                                            <td>
												<a class="btn btn-warning btn-s" data-toggle="modal" data-target="#editModal" 
													...
													data-category="<?php echo $row->food_category_id;?>">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<?php echo form_open_multipart('crud', array('id' => 'edit-form'));?>
						<div class="form-group ">
							<label>Kode menu</label>    
							<input id="edit-code" class="form-control" name="code" placeholder="Kode menu" type="text">
						</div>
						<div class="form-group ">
							<label>Nama menu</label>    
							<input id="edit-name" class="form-control" name="name" placeholder="Nama menu" type="text">
						</div>
						<div class="form-group ">
							<label>Deskripsi</label>
