				...
				<div class="modal-body">
                    <?php echo form_open_multipart('crud/insert_promo', array('id'=> 'edit-form'));?>
						<div class="form-group ">
							...
							<input id="edit-code" class="form-control " name="code" placeholder="Kode promo" type="text" required>
						</div>
						<div class="form-group ">
							<label>Nama promo</label>    
							<input id="edit-name" class="form-control" name="name" placeholder="Nama promo" type="text" required>
